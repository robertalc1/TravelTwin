...
export function LanguageSelector({ className = "" }: { className?: string }) {
  ...
  const current = LANG_LABEL[locale];
  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      ...
      {open && (
        <div
          role="listbox"
          className="absolute right-0 z-50 mt-2 w-44 rounded-xl border border-neutral-200 dark:border-border-default bg-white dark:bg-surface shadow-lg overflow-hidden"
        >
