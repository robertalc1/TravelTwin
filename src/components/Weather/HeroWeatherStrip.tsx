...
export default function HeroWeatherStrip({ lat, lon, startDate, endDate, cityName }: Props) {
  ...
  return (
    <div className="rounded-2xl bg-white/15 dark:bg-black/30 backdrop-blur-md border border-white/20 px-3 py-2.5 shadow-xl">
      <div className="flex items-center gap-2 mb-2 px-1">
        <CloudSun className="h-3.5 w-3.5 text-white/90" />
