...
export const CITY_FALLBACK_DATA: Record<string, CityData> = {
    Paris: {
        attractions: [
    ...
    Barcelona: {
        ...
        restaurants: [
            ...
            { name: 'La Cova Fumada', cuisine: 'Catalan seafood', priceRange: '€€', description: 'Cash-only Barceloneta institution credited with inventing the bombas (potato croquettes) in the 1930s' },
        ],
        cafes: [
