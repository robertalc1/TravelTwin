  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main id="main-content" className="flex-1">
        {/* ═══════════ 1. HERO SECTION ═══════════ */}
        <section className="relative overflow-hidden bg-secondary-500 pt-24 pb-32 lg:pt-28 lg:pb-40">
        ...
        {/* ═══════════ 3. CATEGORY TABS ═══════════ */}
        <section className="border-b border-neutral-200 bg-white sticky top-16 z-30">
            ...
            {hasSearched && (
              <>
                ...
                {searching ? (
                  ...
                  <div className="text-center py-16 rounded-xl bg-white border border-neutral-200">
                    ...
                    return (
                      <div key={code} className="stagger-item">
                        <TripCard
                          ...
                          originalPrice={Math.round(300 + Math.random() * 500)}
                          discountedPrice={Math.round(200 + Math.random() * 400)}
                          currency="EUR"
                          isDirect={i % 2 === 0}
                          travelers={2}
                        />
          ...
          <div className="mx-auto max-w-[1280px] px-4 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {featureCards.map(({ icon: Icon, title, description }) => (
                <div
                  key={title}
                  className="flex items-start gap-4 rounded-xl border border-neutral-200 p-6 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5"
                >
        ...
        <section className="py-12 lg:py-16 bg-neutral-50">
          <div className="mx-auto max-w-[1280px] px-4 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="relative rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 p-8 text-white overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center gap-1 mt-4">
                    <span className="font-bold text-xl">TRYP</span>
              ...
              {/* Featured trip cards */}
              {Object.entries(destinationImages).slice(6, 8).map(([code, img]) => {
                const cities: Record<string, string> = {
                ...
                return (
                  <TripCard
                    ...
                    originalPrice={Math.round(400 + Math.random() * 300)}
                    discountedPrice={Math.round(250 + Math.random() * 250)}
                    currency="EUR"
                    isDirect={false}
                    travelers={2}
                  />
          ...
          <div className="mx-auto max-w-[1280px] px-4 lg:px-8">
            <div className="text-center mb-8">
              ...
              <p className="text-body text-text-secondary max-w-2xl mx-auto">
                Discover our ready-made travel deals on Tryp! Browse the latest real flights and hotel offers
          ...
          <div className="mx-auto max-w-[1280px] px-4 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {articles.map((article) => (
                <div
                  key={article.title}
                  className="group rounded-xl overflow-hidden bg-white border border-neutral-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
                >
